...
int load_choices(void)
{
  ...
  char choices_path_env[MAX_PATHNAME]; /* Value of env var Choices$Path */
  ...
  /* Attempt to load the choices file... */
...
Keeps trying them and returns first successful, or returns NULL. */
